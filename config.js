...
global.github=process.env.GITHUB|| "https://github.com/Bootu-786/PRINCE-MD";
...
global.caption = process.env.CAPTION || global.caption || "ᴘᴏᴡᴇʀᴇᴅ ʙʏ PRINCE-MD" 
...
module.exports = {
  ...
  caption : global.caption || "" , // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ PRINCE-MD 』```", //*『sᴜʙsᴄʀɪʙᴇ • PRINCE』*\n "),
 
  author : process.env.PACK_AUTHER|| "PRINCE",
  packname: process.env.PACK_NAME || "PRINCE",
  botname : process.env.BOT_NAME  || "PRINCE-MD",
